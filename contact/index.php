...
<body>
	<div id="container">
        <div id="contact-form" class="clearfix">
            ...
            <p id="success" class="<?php echo ($sr && $cf['form_ok']) ? 'visible' : ''; ?>">Thanks for your message! We'll reply ASAP!</p>
            <form method="post" action="process.php">
            	<h1><img src="../img/contact-pop.png"/></h1>
                ...
                <select id="enquiry" name="enquiry">
                    ...
                    <option value="Booking" <?php echo ($sr && !$cf['form_ok'] && $cf['posted_form_data']['enquiry'] == 'Booking') ? "selected='selected'" : '' ?>>Booking</option>
                ...
                <textarea id="message" name="message" placeholder="Message" required data-minlength="20"><?php echo ($sr && !$cf['form_ok']) ? $cf['posted_form_data']['message'] : '' ?></textarea>
